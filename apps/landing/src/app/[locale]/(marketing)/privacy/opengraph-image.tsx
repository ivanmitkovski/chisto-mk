  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div>
          <div style={{ fontSize: 48, fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 1.1 }}>{title}</div>
          <div style={{ marginTop: 20, fontSize: 24, color: "#cbd5e1", maxWidth: 900 }}>{t("privacy.description")}</div>
        </div>
