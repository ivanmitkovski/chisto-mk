...
export function FeatureCard({ title, description, icon: Icon }: FeatureCardProps) {
  return (
    ...
    >
      <div
        className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-primary/18 via-primary/10 to-emerald-500/8 ring-1 ring-primary/25 shadow-md shadow-primary/10 transition-shadow duration-300 group-hover:shadow-lg group-hover:ring-primary/35"
        aria-hidden
      >
