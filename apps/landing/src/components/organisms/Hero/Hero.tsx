...
export function Hero() {
  ...
  return (
    <Section className="relative overflow-hidden mesh-hero !pb-20 !pt-7 md:!pb-28 md:!pt-12 lg:!pb-32 lg:!pt-14">
      ...
      />
      <div
        className="pointer-events-none absolute inset-0 z-[1] pattern-dots-large opacity-[0.055] mix-blend-multiply [mask-image:radial-gradient(ellipse_88%_75%_at_50%_42%,black_25%,transparent_78%)] [-webkit-mask-image:radial-gradient(ellipse_88%_75%_at_50%_42%,black_25%,transparent_78%)] max-md:opacity-[0.03]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 z-[1] mesh-hero-depth-clouds opacity-[0.32] md:opacity-[0.38] max-md:opacity-[0.2]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 z-[1] mesh-hero-depth-lines opacity-[0.45] md:opacity-[0.5] max-md:opacity-[0.28]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 z-[1] mesh-hero-depth-particles opacity-[0.55] md:opacity-[0.62] max-md:opacity-[0.35]"
        aria-hidden
      />
      <div className="pointer-events-none absolute inset-0 z-[1] noise-overlay-soft opacity-[0.38] max-md:opacity-[0.22]" aria-hidden />
      <div
        className="pointer-events-none absolute inset-0 z-[1] noise-overlay-fine opacity-[0.16] mix-blend-soft-light md:opacity-[0.2] max-md:opacity-[0.1]"
        aria-hidden
       />
      <div
      ...
      />
      <div
        className="pointer-events-none absolute inset-0 z-[1] shadow-[inset_0_0_100px_rgba(255,255,255,0.12),inset_0_0_56px_rgba(0,0,0,0.008),inset_0_-40px_64px_rgba(0,0,0,0.016)] [mask-image:radial-gradient(ellipse_92%_80%_at_50%_42%,transparent_32%,black_100%)] [-webkit-mask-image:radial-gradient(ellipse_92%_80%_at_50%_42%,transparent_32%,black_100%)]"
        aria-hidden
      />
      <div
      ...
      >
        <div className="absolute inset-0 mesh-hero-illustration" />
      </motion.div>

      <div
        className="pointer-events-none absolute inset-0 z-[9] bg-[linear-gradient(180deg,rgba(255,255,255,0.88)_0%,rgba(255,255,255,0.52)_20%,rgba(255,255,255,0.15)_38%,transparent_55%)] md:bg-[linear-gradient(180deg,rgba(255,255,255,0.62)_0%,rgba(255,255,255,0.28)_24%,transparent_48%)]"
        aria-hidden
      />
