...
export const LEGAL_PUBLIC_DEFAULTS = {
  ...
  registeredAddress: "ул. Сава Михајлов 2 бр.15, Скопје - Гази Баба, Република Македонија",
  ...
  supervisoryAuthorityName: "Agency for Personal Data Protection of the Republic of Macedonia",
  supervisoryAuthorityAddress: "Boulevard Goce Delchev 18, Skopje, Republic of Macedonia",
  ...
  governingLawJurisdiction: "Republic of Macedonia",
  retentionContactMonths: "90 days",
  retentionLogsMonths: "90 days",
  disputeResolutionMechanism: "amicable resolution first, then the competent courts in Skopje, Republic of Macedonia",
  sdkPurpose:
