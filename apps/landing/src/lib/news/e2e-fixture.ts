...
const EN_TITLE =
  'Chisto.mk launches on the App Store, bringing pollution reporting to iPhone users in Macedonia';
...
const EN_BODY = [
  'SKOPJE, 23 June 2026. Chisto.mk, the civic environmental platform developed by the Ekohab association, is now available to iPhone users in Macedonia through the App Store.',
];

const MK_TITLE = 'Chisto.mk на App Store: граѓанско пријавување загадување достапно на iPhone';

const SQ_TITLE =
  'Chisto.mk në App Store: raportimi i ndotjes për përdoruesit e iPhone në Maqedoninë';
