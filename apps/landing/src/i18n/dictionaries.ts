...
const mk: WipDictionary = {
  metaTitle: "Chisto.mk · 17 јуни 2026",
  metaDescription:
    "Платформа за граѓанска екологија во Македонија. Пријавување, мапа и акции за чистење. Стартува на 17 јуни 2026.",
  launchDate: "Стартува на 17 јуни 2026",
  badge: "Во подготовка",
  lead:
...
const en: WipDictionary = {
  metaTitle: "Chisto.mk · June 17, 2026",
  metaDescription:
    "Civic environmental platform for Macedonia. Report issues, explore the map, and join clean-ups. Launching June 17, 2026.",
  launchDate: "Launching June 17, 2026",
...
const sq: WipDictionary = {
  metaTitle: "Chisto.mk · 17 qershor 2026",
  metaDescription:
    "Platformë qytetare mjedisore për Maqedoninë. Raportoni, hartë dhe aksione pastrimi. Nis më 17 qershor 2026.",
  launchDate: "Nis më 17 qershor 2026",
  badge: "Në punë",
  lead:
...
const rom: WipDictionary = {
  metaTitle: "Chisto.mk · 17 juni 2026",
  metaDescription:
    "Platforma thaj ekologjia andre Makedonia. Raporto, dikhe mapa, zhuti khere. Startis 17 juni 2026.",
  launchDate: "Startis 17 juni 2026",
...
const sr: WipDictionary = {
  metaTitle: "Chisto.mk · 17. јун 2026.",
  metaDescription:
    "Грађанска еколошка платформа за Македонију. Пријаве, мапа и акције чишћења. Почетак 17. јуна 2026.",
  launchDate: "Почетак 17. јуна 2026.",
  badge: "У припреми",
  lead:
