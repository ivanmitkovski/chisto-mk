...
void main() {
  testWidgets('AuthValidators uses l10n for email and phone', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('messageForAuthError maps known codes', (
    WidgetTester tester,
  ) async {
    late AppLocalizations l10n;
    await tester.pumpWidget(
    ...
    expect(
      messageForAuthError(
        l10n,
        const AppError(code: 'INVALID_CREDENTIALS', message: 'x'),
      ),
