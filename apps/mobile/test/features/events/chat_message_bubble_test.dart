...
Widget _wrap(Widget child, {double textScale = 1.0}) {
  final EventChatAudioPlaybackController audio =
...
Future<Uint8List> _stubDownloadRemote(String url) async => Uint8List(0);
...
void main() {
    ...
    await tester.pumpWidget(
      _wrap(
        ChatMessageBubble(
          ...
          isFirstInGroup: true,
          isLastInGroup: true,
          downloadRemoteAttachment: _stubDownloadRemote,
        ),
        textScale: 1.45,
      ),
    );
  ...
  testWidgets('peer bubble shows avatar on lastInGroup', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      _wrap(
  ...
  testWidgets('deleted message shows italic removed text', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      _wrap(
  ...
  testWidgets('audio bubble shows play control and duration', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      _wrap(
  ...
  testWidgets('peer message long-press offers report action', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      _wrap(
  ...
  testWidgets('own message long-press does not offer report', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      _wrap(
  ...
  testWidgets('location bubble shows pin icon and label', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      _wrap(
