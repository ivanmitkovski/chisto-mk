...
void main() {
  group('skopjeCalendarWeekBoundsInclusive', () {
    test(
      'Tuesday 2026-04-21 UTC maps to Mon Apr 20–Sun Apr 26 (UTC calendar dates)',
      () {
    ...
    test(
      'Monday Skopje week start: reference on Monday yields same Monday dateFrom',
      () {
