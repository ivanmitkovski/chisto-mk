...
void main() {
  test('eventParticipantsPageFromJson parses data and meta', () {
    final EventParticipantsPage page = eventParticipantsPageFromJson(
      <String, dynamic>{
        'data': <dynamic>[
          <String, dynamic>{
            'userId': 'u1',
        ...
        'meta': <String, dynamic>{'hasMore': true, 'nextCursor': 'abc'},
      },
    );
    ...
    expect(
      page.items.single.joinedAt.toUtc().toIso8601String(),
