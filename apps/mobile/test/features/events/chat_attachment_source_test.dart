...
void main() {
  group('isEventChatRemoteAttachmentUrl', () {
    test('true for http and https', () {
      expect(
        isEventChatRemoteAttachmentUrl('https://cdn.example.com/a.jpg'),
        isTrue,
      );
    ...
    test('false for paths and file scheme', () {
      ...
      expect(isEventChatRemoteAttachmentUrl(r'C:\\temp\\a.jpg'), isFalse);
    });
  });
  ...
  group('eventChatAttachmentFilePath', () {
    test('strips file scheme', () {
      expect(
        eventChatAttachmentFilePath(
          'file:///tmp/chat_attachment_source_foo.jpg',
        ),
    ...
    test('returns bare path unchanged', () {
      expect(
        eventChatAttachmentFilePath('/data/user/0/app/cache/x.png'),
        '/data/user/0/app/cache/x.png',
      );
    });
  });
}
