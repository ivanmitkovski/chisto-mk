...
void main() {
  test(
    'kNotificationPreferenceGroups covers every UserNotificationType once',
    () {
  ...
  test(
    'isNotificationPreferenceGroupEnabled is true when any type is unmuted',
    () {
      ...
      expect(isNotificationPreferenceGroupEnabled(system, byType), isTrue);
    },
  );
