...
void main() {
  group('push and inbox routing parity', () {
    test('report_received resolves to report detail from push data and inbox item', () {
    ...
    test('CLEANUP_EVENT with siteId resolves to event detail not map focus', () {
    ...
    test('REPORT_STATUS with reportId resolves to report detail from push data', () {
      final NotificationNavigationTarget target =
          resolveNotificationNavigationTargetFromData(<String, dynamic>{
            'type': 'REPORT_STATUS',
            'reportId': 'report_abc',
