...
void main() {
  ...
  testWidgets('ReportSubmittedDialog golden sq', (WidgetTester tester) async {
        ...
        home: const MediaQuery(
          ...
          child: Center(
            child: ReportSubmittedDialog(
              categoryLabel: 'Deponi e paligjshme',
    ...
    await expectLater(
      ...
      matchesGoldenFile('__goldens__/report_submitted_dialog_sq.png'),
    );
  });
}
