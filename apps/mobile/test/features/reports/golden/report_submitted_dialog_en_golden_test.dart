...
void main() {
  ...
  testWidgets('ReportSubmittedDialog golden en', (WidgetTester tester) async {
        ...
        home: const MediaQuery(
          ...
          child: Center(
            child: ReportSubmittedDialog(
              categoryLabel: 'Illegal landfill',
    ...
    await expectLater(
      ...
      matchesGoldenFile('__goldens__/report_submitted_dialog_en.png'),
    );
  });
}
