...
void main() {
  ...
  group('formatReportCapacityRetryDuration', () {
    test('uses soon for null or non-positive', () {
      expect(formatReportCapacityRetryDuration(l10n, null), l10n.reportCooldownRetrySoon);
      expect(formatReportCapacityRetryDuration(l10n, 0), l10n.reportCooldownRetrySoon);
    });

    test('formats days, hours, and minutes', () {
      const int sixDays23h57m =
          6 * 86400 + 23 * 3600 + 57 * 60;
      final String s =
          formatReportCapacityRetryDuration(l10n, sixDays23h57m);
    ...
    test('formats seconds when under one minute', () {
      expect(
        formatReportCapacityRetryDuration(l10n, 45),
        '45 seconds',
      );
    });
  });
