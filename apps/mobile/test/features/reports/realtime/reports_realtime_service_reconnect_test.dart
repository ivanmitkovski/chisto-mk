...
void main() {
  test(
    'delegates connectionState, events, streak; requestReconnect hits transport',
    () {
      ...
      expect(
        identical(
          svc.reconnectStreakSinceLive,
          transport.reconnectStreakSinceLive,
        ),
        isTrue,
      );
