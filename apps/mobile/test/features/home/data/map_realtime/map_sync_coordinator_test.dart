...
void main() {
  ...
  test(
    'MapViewportQuery.containsViewport requires matching bounds and params',
    () {
  ...
  test(
    'predictive prefetch calls repository with prefetch after fast pan',
    () async {
      ...
      final MapSyncCoordinator c = MapSyncCoordinator(
  ...
  test(
    'skips debounced full sync when viewport stays inside last envelope',
    () async {
  ...
  test(
    '429 applies cooldown so immediate follow-up syncs do not stack fetches',
    () async {
