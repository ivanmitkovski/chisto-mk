...
void main() {
  test('select and deselect update selection state', () {
    ...
    final MapSelectionNotifier notifier = container.read(
      mapSelectionNotifierProvider.notifier,
    );
  ...
  test(
    'resolveSiteAndPoint fetches from repository when absent locally',
    () async {
