...
class _AppButtonState extends State<AppButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget child = _buildChild(busy, canPress, height);
  ...
  Widget _buildChild(bool busy, bool canPress, double height) {
    final TextStyle labelStyle = AppTypography.buttonLabel.copyWith(
