...
SiteHistorySectionBucket _bucketFor(
  DateTime occurredAt,
  DateTime now,
) {
...
DateTime? _anchorForBucket(SiteHistorySectionBucket bucket, DateTime occurredAt) {
...
bool _sameSection(
  ...
  return anchor?.year == otherAnchor?.year && anchor?.month == otherAnchor?.month;
}
