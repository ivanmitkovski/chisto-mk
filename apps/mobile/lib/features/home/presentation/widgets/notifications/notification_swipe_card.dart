...
import 'package:chisto_mobile/features/home/presentation/widgets/notifications/notification_swipe_action_pane.dart';
...
class _NotificationSwipeCardState extends State<NotificationSwipeCard>
  ...
  Future<void> _onDragEnd(DragEndDetails details) async {
    ...
    final bool commitRead = _dragOffset > 0 &&
        (_dragOffset >= _triggerThreshold || velocity > _velocityTrigger);
    final bool commitArchive = _dragOffset < 0 &&
        (_dragOffset <= -_triggerThreshold || velocity < -_velocityTrigger);
    ...
    return ClipRRect(
      ...
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          final double leftStripWidth =
              leftReveal > 0 ? leftReveal + _stripOverlap : 0;
          final double rightStripWidth =
              rightReveal > 0 ? rightReveal + _stripOverlap : 0;
