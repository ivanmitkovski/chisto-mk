part of 'package:chisto_mobile/features/events/presentation/organizer_checkin/organizer_checkin_screen.dart';
    ...
    if (AppBootstrap.instance.isInitialized) {
      unawaited(
        _organizerEndSoonLocal.sync(
          event: event,
          push: AppBootstrap.instance.pushNotificationService,
          l10n: l10n,
        ),
      );
    }
            ...
            Expanded(
              child: CustomScrollView(
                ...
                slivers: <Widget>[
                  ...
                  ..._buildCheckedInAttendeeSlivers(context, textTheme, attendees, l10n),
                  SliverToBoxAdapter(
                    child: SizedBox(
                      height:
