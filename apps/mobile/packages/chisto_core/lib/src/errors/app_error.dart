class AppError implements Exception {
  ...
  /// HTTP 401 codes where [ApiClient] may refresh once and retry the request.
  ///
  /// Includes `INVALID_TOKEN` from optional-auth routes (feed, map) when the
  /// access JWT is expired but the refresh token may still be valid.
