...
import 'package:feature_profile/src/presentation/screens/profile_language_screen.dart';
import 'package:feature_profile/src/presentation/screens/profile_password_screen.dart';
import 'package:feature_profile/src/presentation/widgets/profile_authenticated_body.dart';
    ...
    switch (phase) {
      ...
      case 'guest':
        return Semantics(
          container: true,
          label:
              '${context.l10n.profileGuestTitle}. ${context.l10n.profileGuestSubtitle}',
          child: AppEmptyState(
            ...
            action: Semantics(
              button: true,
              label: context.l10n.authSignInCta,
