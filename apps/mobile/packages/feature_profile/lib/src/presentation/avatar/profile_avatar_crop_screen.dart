...
class _ProfileAvatarCropScreenState extends State<ProfileAvatarCropScreen> {
  ...
  Future<void> _prepareImage() async {
    ...
    final int maxDecodeWidth =
        (mq.size.shortestSide * mq.devicePixelRatio * 2.2).round().clamp(
          1024,
          kAvatarCropDecodeWidthMax,
        );
                ...
                child: Padding(
                  ...
                  child: DecoratedBox(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: AppShadows.profileCropToolbar(),
                    ),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(
                        AppSpacing.radiusCard,
                      ...
                      child: AnimatedSwitcher(
                        ...
                        switchInCurve: AppMotion.smooth,
                        switchOutCurve: AppMotion.standardCurve,
                        child: _buildCardContent(context, l10n),
                      ),
                    ),
                  ),
                ),
