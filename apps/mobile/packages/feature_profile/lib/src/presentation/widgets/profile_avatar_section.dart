...
class ProfileAvatarSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const double avatarDiameter = AppSpacing.avatarLg + AppSpacing.lg;
    return Center(
      child: Column(
        children: <Widget>[
          Semantics(
                ...
                onLongPress: canPeekAvatar
                    ? () {
                        ...
                        ProfileAvatarPeek.show(
                          context,
                          image: image,
                          semanticLabel: context.l10n.profileAvatarPeekSemantic,
                        );
                      }
                    : null,
                onLongPressUp: canPeekAvatar ? ProfileAvatarPeek.hide : null,
          ...
          ExcludeSemantics(
            child: AnimatedSwitcher(
              ...
              child: Text(
                ...
                style: AppTypographySurfaces.profileAvatarCaption(
