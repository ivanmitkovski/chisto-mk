...
import 'package:chisto_infrastructure/shared/widgets/organisms/profile_avatar_peek_overlay.dart';
...
ImageProvider? profileHeaderPeekImageProvider(
  ...
  final String? url = profilePeekNormalizeUrl(
    avatar.remoteUrl ?? user.avatarUrl,
  );
...
class ProfileHeader extends ConsumerWidget {
  const ProfileHeader({super.key, required this.user, this.onProfileUpdated});
              ...
              children: <Widget>[
                Builder(
                  builder: (BuildContext context) {
                    final bool canPeek = profileHeaderHasPeekablePhoto(
                      user,
                      avatar,
                    );
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        ...
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: AppTypographySurfaces.profileHeaderPhoneOnDark(
