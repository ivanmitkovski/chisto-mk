...
import 'package:chisto_infrastructure/shared/widgets/organisms/app_header_bar.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TabBar(
        ...
        unselectedLabelStyle: AppTypography.chipLabel(
          textTheme,
        ).copyWith(fontWeight: FontWeight.w400, color: AppColors.textMuted),
        tabs: <Widget>[
