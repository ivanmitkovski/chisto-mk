...
class MapLayoutTokens {
  ...
  static const EdgeInsets geoFitPadding = EdgeInsets.fromLTRB(
    AppSpacing.avatarMd,
  ...
  static const double clusterExpandPadding = AppSpacing.xxl + AppSpacing.lg;
  ...
  static const double geoFitMinZoomMunicipality = 10;
