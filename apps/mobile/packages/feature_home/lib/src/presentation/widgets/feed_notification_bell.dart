...
part 'feed_notification_bell_test_access.dart';
  ...
  Widget _buildBellBody({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: AppShadows.notificationBell(m),
      ),
      child: Center(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: AppShadows.notificationBadge(m),
                    ),
                    child: Center(
                      child: Text(
                        widget.unreadCount > 9 ? '9+' : '${widget.unreadCount}',
                        style: AppTypographySurfaces.homeNotificationBadge(
