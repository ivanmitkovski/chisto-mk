...
import 'package:feature_home/src/presentation/widgets/site_card/site_card_text_utils.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        final TextStyle titleStyle = AppTypography.cardTitle(
          textTheme,
        ).copyWith(fontWeight: FontWeight.w700);
        final TextStyle descStyle = AppTypography.cardSubtitle(
          textTheme,
