...
import 'package:feature_home/src/presentation/widgets/site_card/site_upvote_motion.dart';
import 'package:flutter/material.dart';

/// Feed icon vs detail stats chip — shared motion, press feedback, and busy state.
enum SiteUpvoteAffordanceVariant { barIcon, statChip }
...
class _SiteUpvoteAffordanceState extends State<SiteUpvoteAffordance>
  ...
  void initState() {
    super.initState();
    _pop =
        AnimationController(vsync: this, duration: SiteUpvoteMotion.popDuration)
  ...
  Widget _scaledHitChild({required Widget child}) {
    ...
    final double pressMul = _pressed && motion
        ? SiteUpvoteMotion.iconPressedScale
        : 1.0;
    ...
    switch (widget.variant) {
      ...
      case SiteUpvoteAffordanceVariant.statChip:
        ...
        final TextStyle labelStyle =
            (widget.countTextStyle ?? AppTypography.chipLabel(textTheme))
