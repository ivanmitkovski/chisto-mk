...
import 'package:feature_home/src/presentation/widgets/map/map_shimmer_box.dart';
...
class _SitePreviewSheetState extends State<SitePreviewSheet>
  ...
  void initState() {
    ...
    _entranceSlide =
        Tween<Offset>(begin: const Offset(0, 0.045), end: Offset.zero).animate(
          CurvedAnimation(parent: _entranceController, curve: AppMotion.smooth),
        );
  ...
  Widget build(BuildContext context) {
    ...
    final Color titleColor = widget.useDarkTiles
    ...
    final Widget previewCard = Transform.translate(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: AppShadows.sitePreviewPanel(),
              ),
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        SitePreviewImage(site: site, dark: widget.useDarkTiles),
...
class CompactBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        label,
        style: AppTypographySurfaces.homeSitePreviewStatusChip(
            ...
            children: <Widget>[
              Expanded(
                child: Text(
                  ...
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: AppTypographySurfaces.homeSitePreviewActionPill(
                    Theme.of(context).textTheme,
                    color: fg,
                  ),
                ),
