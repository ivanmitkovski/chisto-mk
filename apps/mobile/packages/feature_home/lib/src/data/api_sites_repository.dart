...
import 'package:feature_home/src/data/api_feed_analytics_repository.dart';
...
class ApiSitesRepository implements SitesRepository {
  ApiSitesRepository({required ApiClient client, AuthState? authState}) {
  ...
  }) => _feed.searchSitesForMap(request, cancellation: cancellation);
