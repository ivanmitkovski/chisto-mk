...
abstract final class MacedoniaMapRegions {
  ...
  static List<LatLng> fenceRingFor(String? geoAreaId) {
    ...
    return <LatLng>[b.southWest, b.southEast, b.northEast, b.northWest];
  }

  static final Map<String, LatLngBounds> _bounds = mapRegionBounds.map(
    (String id, LatLngBounds b) =>
        MapEntry<String, LatLngBounds>(id, _clampBounds(b)),
  );
