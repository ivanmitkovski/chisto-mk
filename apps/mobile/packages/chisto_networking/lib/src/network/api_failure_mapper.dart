...
AppError appErrorFromFailedResponse({
  ...
  if (statusCode == 404) {
    final String resolvedCode = json?['code'] is String
        ? json!['code'] as String
        : 'NOT_FOUND';
  ...
  if (statusCode >= 500) {
    return AppError.server(message: message, serverTimestamp: serverTimestamp);
  }
  if (statusCode == 408 || statusCode == 504) {
    return AppError.timeout(message: message, serverTimestamp: serverTimestamp);
  }
  return AppError(
    code: code,
    message: message,
