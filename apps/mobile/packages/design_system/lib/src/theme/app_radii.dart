...
abstract final class AppRadii {
  ...
  static BorderRadius get handle =>
      BorderRadius.circular(AppSpacing.radiusHandle);
  static BorderRadius get chatMicro =>
      BorderRadius.circular(AppSpacing.radiusChatMicro);
  static BorderRadius get progress =>
      BorderRadius.circular(AppSpacing.radiusProgress);
  ...
  static BorderRadius onlyTopSheet() =>
