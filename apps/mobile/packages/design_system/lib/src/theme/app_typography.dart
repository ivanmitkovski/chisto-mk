...
///
/// Canonical scale and usage: see [AppText] and this file.
///
...
/// Tier-2 helpers take [TextTheme] from [Theme.of] so Roboto and dynamic type apply.
///
...
class AppTypography {
  ...
  /// Applies the ambient theme's Roboto [fontFamily] onto [base] when present.
  static TextStyle mergeRoboto(TextTheme theme, TextStyle base) {
    final family =
        theme.bodyMedium?.fontFamily ?? textTheme.bodyMedium?.fontFamily;
  ...
  static TextStyle authHeadline(TextTheme theme) =>
      theme.headlineLarge ?? textTheme.headlineLarge!;

  /// Title on login, register, and password-reset form screens ([AuthScreenHeader]).
  static TextStyle authScreenTitle(TextTheme theme) =>
  ...
  static TextStyle authScreenSubtitle(TextTheme theme) =>
  ...
  static TextStyle microLabel(TextTheme theme) =>
      (theme.labelSmall ?? textTheme.labelSmall!).copyWith(
        fontSize: 11,
        fontWeight: FontWeight.w600,
        letterSpacing: -0.1,
      );
  ...
  static TextStyle microIndex(TextTheme theme) =>
      (theme.labelSmall ?? textTheme.labelSmall!).copyWith(
        fontSize: 9,
        fontWeight: FontWeight.w600,
        letterSpacing: -0.1,
  ...
  static TextStyle overlayBodyMedium(TextTheme theme) =>
      (theme.bodyMedium ?? textTheme.bodyMedium!).copyWith(
        fontWeight: FontWeight.w500,
      );

  static TextStyle authSecondaryMuted(TextTheme theme) =>
      (theme.bodySmall ?? textTheme.bodySmall!).copyWith(
        color: AppColors.textMuted,
        height: 1.35,
      );

  static TextStyle authSecondaryEmphasis(TextTheme theme) =>
      (theme.bodySmall ?? textTheme.bodySmall!).copyWith(
  ...
  static TextStyle homeFeedCaughtUpTitle(TextTheme theme) =>
      (theme.bodySmall ?? textTheme.bodySmall!).copyWith(
        color: AppColors.textMuted,
        fontWeight: FontWeight.w500,
      );

  static TextStyle homeFeedCaughtUpSubtitle(TextTheme theme) =>
      (theme.labelSmall ?? textTheme.labelSmall!).copyWith(
        color: AppColors.textMuted.withValues(alpha: 0.6),
      );

  static TextStyle profileWeeklyRankSecondary(TextTheme theme) =>
      (theme.bodyMedium ?? textTheme.bodyMedium!).copyWith(
        color: AppColors.textMuted,
        fontWeight: FontWeight.w600,
      );

  static TextStyle profileWeeklyRankPrimary(
    TextTheme theme, {
  ...
  static TextStyle authTextLink(TextTheme theme) => mergeRoboto(
    theme,
    const TextStyle(color: AppColors.primaryDark, fontWeight: FontWeight.w700),
  );

  static TextStyle authTextLinkUnderline(TextTheme theme) => mergeRoboto(
    theme,
    const TextStyle(
      color: AppColors.primaryDark,
      fontWeight: FontWeight.w700,
  ...
  ///
  /// Pass [fontFamily] from `Theme.of(context).textTheme.bodyMedium?.fontFamily`
  /// so initials match the app typeface (Roboto via [AppTheme]).
  ...
  static TextStyle galleryMoreCount(TextTheme theme) =>
      (theme.titleMedium ?? textTheme.titleMedium!).copyWith(
        color: AppColors.textOnDark,
        fontWeight: FontWeight.w600,
      );

  static TextStyle authSubtitle(TextTheme theme) =>
      (theme.bodyMedium ?? textTheme.bodyMedium!).copyWith(
        color: AppColors.textSecondary,
        height: 1.4,
      );

  static TextStyle pillLabel(TextTheme theme) =>
      (theme.bodySmall ?? textTheme.bodySmall!).copyWith(
        fontWeight: FontWeight.w600,
        color: AppColors.textPrimary,
      );

  static TextStyle sectionHeader(TextTheme theme) =>
  ...
  static TextStyle chipLabel(TextTheme theme) =>
      (theme.labelMedium ?? textTheme.labelMedium!).copyWith(
        letterSpacing: -0.2,
      );

  static TextStyle sheetTitle(TextTheme theme) =>
      (theme.titleMedium ?? textTheme.titleMedium!).copyWith(
        fontWeight: FontWeight.w700,
        color: AppColors.textPrimary,
      );

  static TextStyle badgeLabel(TextTheme theme) =>
      (theme.labelSmall ?? textTheme.labelSmall!).copyWith(
        fontSize: 11,
        fontWeight: FontWeight.w700,
        letterSpacing: 0.3,
  ...
  static TextStyle emptyStateSubtitle(TextTheme theme) =>
      (theme.bodyMedium ?? textTheme.bodyMedium!).copyWith(
        color: AppColors.textMuted,
        height: 1.5,
      );

  static TextStyle buttonLabel(TextTheme theme) =>
      theme.labelLarge ?? textTheme.labelLarge!;
  ...
  /// Merges with [TextTheme] so [AppTheme]'s Roboto applies.
  static TextStyle eventsCardPillLabel(
    TextTheme theme, {
    required Color color,
  }) => badgeLabel(theme).copyWith(color: color);
  ...
  static TextStyle eventsSheetTitle(TextTheme theme) =>
      sheetTitle(theme).copyWith(letterSpacing: -0.3);
  ...
  static TextStyle eventsDisplayStat(TextTheme theme) =>
      (theme.headlineSmall ?? textTheme.headlineSmall!).copyWith(
        fontWeight: FontWeight.w700,
        color: AppColors.textPrimary,
        letterSpacing: -0.35,
        height: 1.08,
  ...
  static TextStyle eventsLocationSheetAddress(TextTheme theme) =>
      (theme.bodyLarge ?? textTheme.bodyLarge!).copyWith(
        fontWeight: FontWeight.w600,
        color: AppColors.textPrimary,
        height: 1.35,
