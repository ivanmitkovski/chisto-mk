...
class AppMotion {
  ...
  /// Spring used for geographic marker settle after cluster reflow.
  static SpringDescription get mapMarkerSettleSpring => gentleSpring;
  ...
  static void syncRepeatingShimmer(
    ...
    assert(staticValue >= 0 && staticValue <= 1, 'staticValue must be in 0..1');
  ...
  static const Curve smooth = Cubic(0.33, 0, 0.2, 1);
  static const Curve spring = Curves.easeOutBack;
  static const Curve standardCurve = Curves.easeOutCubic;
  static const Curve decelerate = Curves.easeInOutCubic;
  static const Curve sharpDecelerate = Cubic(0.2, 0, 0, 1);
  ...
  static SpringDescription get bouncySpring =>
      const SpringDescription(mass: 1, stiffness: 300, damping: 18);
