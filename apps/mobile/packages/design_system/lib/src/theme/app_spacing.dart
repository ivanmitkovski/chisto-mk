class AppSpacing {
  ...
  /// Hairline inset (e.g. chat meta, photo grid frame).
  static const double insetTight = 3;

  static const double xs = 6;
  static const double sm = 12;
  static const double md = 16;

  /// Horizontal gap between profile avatar and greeting on [FeedHeader] (pollution feed home).
  static const double feedHeaderAvatarToTextGap = md;
