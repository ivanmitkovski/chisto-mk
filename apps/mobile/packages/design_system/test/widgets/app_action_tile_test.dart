...
void main() {
  testWidgets('AppActionTile uses clipped Material surface without Ink decoration', (
    WidgetTester tester,
  ) async {
    ...
    expect(tester.widget<Material>(surfaceMaterial).clipBehavior, Clip.antiAlias);
