...
class AppLocalizationsSq extends AppLocalizations {
  ...
  @override
  String get authShowPasswordTooltip => 'Shfaq fjalëkalimin';

  @override
  String get authHidePasswordTooltip => 'Fshih fjalëkalimin';
  ...
  @override
  String get profileGuestTitle => 'Hyni për të parë profilin tuaj';

  @override
  String get profileGuestSubtitle =>
      'Ndiqni pikët, menaxhoni cilësimet dhe shihni ndikimin tuaj.';
  ...
  @override
  String get profileGeneralEmptyValue => 'Nuk disponohet';
  ...
  String reportSubmitPhotosSkippedSnack(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count foto ishin shumë të mëdha ose mungonin dhe nuk u ngarkuan.',
      one: '1 foto ishte shumë e madhe ose mungonte dhe nuk u ngarkua.',
    );
    return '$_temp0';
  }
  ...
  String reportSubmitPhotosCompressionWarningSnack(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count foto nuk u kompresuan; u përdorën origjinalët.',
      one: '1 foto nuk u kompresua; u përdor origjinali.',
    );
    return '$_temp0';
  }

  @override
  String get reportListOutboxQueuedChip => 'Raporti në radhë për dërgim…';

  @override
  String get reportListOutboxUploadingChip => 'Duke ngarkuar fotot…';

  @override
  String get reportListOutboxSubmittingChip => 'Duke dërguar raportin…';

  @override
  String get reportListOutboxFailedBanner =>
      'Dërgimi dështoi. Prek Riprovo për ta provuar përsëri.';

  @override
  String get reportListOutboxFailedRetry => 'Riprovo';

  @override
  String get reportListOutboxOfflineBanner => 'Raporti po pret lidhjen…';

  @override
  String get reportListOutboxCooldownBanner =>
      'Raporti u ndal. Provo përsëri pas cooldown-it.';

  @override
  String get reportDraftRestoreFailedSnack =>
      'Skica nuk u rikthye. Po fillojmë nga e para.';
  ...
  @override
  String get feedNoLocationTitle => 'Nevojitet qasja te vendndodhja';

  @override
  String get feedNoLocationHint =>
      'Aktivizoni vendndodhjen te Cilësimet për të parë vendet afër jush.';

  @override
  String get feedNoLocationOpenSettings => 'Hap Cilësimet';
  ...
  @override
  String get mapSearchMinQueryTitle => 'Vazhdoni të shkruani';

  @override
  String get mapSearchMinQuerySubtitle =>
      'Shkruani të paktën 2 karaktere për kërkim.';
  ...
  @override
  String get mapSearchSemanticSearching => 'Duke kërkuar të gjitha vendet';
  ...
  @override
  String get mapSearchSemanticNoResults => 'Nuk u gjet asgjë';

  @override
  String get mapSearchSemanticRemoteError =>
      'Nuk u krye kërkimi në të gjitha vendet';

  @override
  String get mapSearchNoResultsResetFilters => 'Rivendos filtrat';
  ...
  @override
  String get mapSearchSheetTitle => 'Kërko';
  ...
  String mapSearchRecentChipSemantic(String query) {
    return 'Kërkim i fundit $query';
  }

  @override
  String get mapSearchGeoIntentSubtitle => 'Shfaq zonën në hartë';

  @override
  String mapSearchGeoIntentSemantic(String label) {
    return 'Shfaq $label në hartë';
  }
  ...
  String get mapLocateFailedSnack =>
      'Nuk u gjet vendndodhja juaj. Kontrolloni që shërbimet e vendndodhjes janë aktivizuar.';
  ...
  @override
  String get mapFilterButtonSemanticNoSites => 'Nuk ka vende të ngarkuara.';
  ...
  String mapFilterButtonSemanticSitesMatch(int count) {
    return '$count vende përputhen me filtrat.';
  }
  ...
  String get mapFilterArchivedSubtitle =>
      'Vendet e arkivuara fshihen si parazgjedhje dhe nuk kontrollohen nga status chips.';

  @override
  String mapFilterShowSites(int count) {
    return 'Shfaq $count vende';
  }

  @override
  String get mapFilterSectionSelectAll => 'Të gjitha';

  @override
  String get mapFilterSectionClear => 'Pastro';

  @override
  String get mapFilterMinSelectionAnnounce =>
      'Të paktën një opsion duhet të mbetet i zgjedhur.';

  @override
  String get mapFilterAreaSearchPlaceholder => 'Kërko komunat dhe zonat';
  ...
  String get reportPhotoReviewZoomResetHint =>
      'Prek dy herë për të rikthyer zmadhimin';

  @override
  String get reportPhotoReviewZoomInspectHint =>
      'Zmadho me gishta ose prek dy herë për shqyrtim';
  ...
  @override
  String get notificationsSemanticReadState => 'Lexuar';

  @override
  String get notificationsSemanticUnreadState => 'Palexuar';
  ...
  String notificationsTileSemanticLabel(
    ...
    return '$state njoftim $type: $title';
  }

  @override
  String get notificationsTileOpenRelatedHint => 'Hap përmbajtjen e lidhur';
  ...
  String get eventsOrganizerCheckInPauseResumeFailed =>
      'Nuk mund të përditësohej regjistrimi. Provo përsëri.';
  ...
  @override
  String get eventsAttendeeReminderNotifyTitle => 'Rikujtues për ngjarjen';

  @override
  String eventsAttendeeReminderNotifyBody(String title) {
    return '$title po afrohet. Prekni për ta hapur.';
  }
  ...
  String get eventsDetailCalendarAlreadyAdded =>
      'Tashmë është në kalendarin tuaj.';

  @override
  String get eventsAddToCalendarAlreadyAdded => 'Shtuar në kalendar';
  ...
  @override
  String get donateSheetTitle => 'Mbështet përpjekjet e pastrimit';

  @override
  String get donateSheetSubtitle =>
      'Kontributi yt ndihmon të organizohen pastrime dhe vendet të mbeten të shëndetshme.';

  @override
  String get donateSheetOneTimeTitle => 'Donacion njëherësh';

  @override
  String get donateSheetOneTimeSubtitle => 'Dhuro një herë për këtë kauzë';

  @override
  String get donateSheetMonthlyTitle => 'Kontribut mujor';

  @override
  String get donateSheetMonthlySubtitle =>
      'Mbështetje periodike për pastrime të vazhdueshme';
  ...
  String siteHistoryKindStatusChanged(String from, String to) {
    return 'Statusi ndryshoi nga $from në $to';
  }
  ...
  String siteHistorySummaryActiveSince(String date) {
    return 'Aktiv që nga $date';
  }

  @override
  String get siteHistoryStatReports => 'Raporte';

  @override
  String get siteHistoryStatCleanups => 'Pastrime';

  @override
  String get siteHistoryStatEntries => 'Hyrje';
  ...
  @override
  String get siteHistoryLoadingSemantic => 'Po ngarkohet historiku i vendit.';
  ...
  @override
  String get commonNotAvailable => 'Nuk disponohet';
  ...
  @override
  String get pushPermissionOpenSettingsTitle => 'Aktivizo njoftimet';

  @override
  String get pushPermissionOpenSettingsBody =>
      'Njoftimet janë të fikura për Chisto.mk. Hap Cilësimet për të lejuar alarmet për pastrim, ngjarje dhe bisedë.';

  @override
  String get pushPermissionOpenSettingsAction => 'Hap Cilësimet';

  @override
  String get locationPermissionDeniedSnack =>
      'Qasja te vendndodhja është e fikur. Hap Cilësimet për ta aktivizuar.';

  @override
  String get locationPermissionOpenSettingsTitle => 'Aktivizo vendndodhjen';

  @override
  String get locationPermissionOpenSettingsBody =>
      'Vendndodhja është e fikur për Chisto.mk. Hap Cilësimet për të parë vendet afër dhe për të qendruar hartën te ju.';

  @override
  String get locationPermissionOpenSettingsAction => 'Hap Cilësimet';
  ...
  @override
  String get locationPickerAddressPlaceholder => 'Nuk ka adresë';
