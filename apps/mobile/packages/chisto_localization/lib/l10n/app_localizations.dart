...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Track points, manage settings, and see your impact.'**
  ...
  /// No description provided for @reportSubmitPhotosSkippedSnack.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 photo was too large or missing and was not uploaded.} other{{count} photos were too large or missing and were not uploaded.}}'**
  String reportSubmitPhotosSkippedSnack(int count);

  /// No description provided for @reportSubmitPhotosCompressionWarningSnack.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 photo could not be compressed; the original was used.} other{{count} photos could not be compressed; originals were used.}}'**
  String reportSubmitPhotosCompressionWarningSnack(int count);

  /// No description provided for @reportListOutboxQueuedChip.
  ///
  /// In en, this message translates to:
  /// **'Report queued for upload…'**
  String get reportListOutboxQueuedChip;

  /// No description provided for @reportListOutboxUploadingChip.
  ///
  /// In en, this message translates to:
  /// **'Uploading report photos…'**
  String get reportListOutboxUploadingChip;

  /// No description provided for @reportListOutboxSubmittingChip.
  ///
  /// In en, this message translates to:
  /// **'Submitting report…'**
  String get reportListOutboxSubmittingChip;

  /// No description provided for @reportListOutboxFailedBanner.
  ///
  /// In en, this message translates to:
  /// **'Report submission failed. Tap Retry to send again.'**
  String get reportListOutboxFailedBanner;

  /// No description provided for @reportListOutboxFailedRetry.
  ///
  /// In en, this message translates to:
  /// **'Retry'**
  String get reportListOutboxFailedRetry;

  /// No description provided for @reportListOutboxOfflineBanner.
  ///
  /// In en, this message translates to:
  /// **'Report waiting for connection…'**
  String get reportListOutboxOfflineBanner;

  /// No description provided for @reportListOutboxCooldownBanner.
  ///
  /// In en, this message translates to:
  /// **'Report paused. Try again after the cooldown.'**
  String get reportListOutboxCooldownBanner;

  /// No description provided for @reportDraftRestoreFailedSnack.
  ///
  /// In en, this message translates to:
  /// **'Could not restore your saved draft. Starting fresh.'**
  String get reportDraftRestoreFailedSnack;
  ...
  /// No description provided for @feedNoLocationTitle.
  ///
  /// In en, this message translates to:
  /// **'Location access needed'**
  String get feedNoLocationTitle;

  /// No description provided for @feedNoLocationHint.
  ///
  /// In en, this message translates to:
  /// **'Turn on location in Settings to see sites near you.'**
  String get feedNoLocationHint;

  /// No description provided for @feedNoLocationOpenSettings.
  ///
  /// In en, this message translates to:
  /// **'Open Settings'**
  String get feedNoLocationOpenSettings;
  ...
  /// No description provided for @mapSearchMinQueryTitle.
  ///
  /// In en, this message translates to:
  /// **'Keep typing'**
  String get mapSearchMinQueryTitle;

  /// No description provided for @mapSearchMinQuerySubtitle.
  ///
  /// In en, this message translates to:
  /// **'Enter at least 2 characters to search.'**
  String get mapSearchMinQuerySubtitle;
  ...
  /// No description provided for @mapSearchSemanticSearching.
  ///
  /// In en, this message translates to:
  /// **'Searching all sites'**
  String get mapSearchSemanticSearching;

  /// No description provided for @mapSearchSemanticResults.
  ///
  /// In en, this message translates to:
  /// **'{count} results'**
  String mapSearchSemanticResults(int count);

  /// No description provided for @mapSearchSemanticNoResults.
  ///
  /// In en, this message translates to:
  /// **'No matching sites'**
  String get mapSearchSemanticNoResults;

  /// No description provided for @mapSearchSemanticRemoteError.
  ///
  /// In en, this message translates to:
  /// **'Could not search all sites'**
  String get mapSearchSemanticRemoteError;

  /// No description provided for @mapSearchNoResultsResetFilters.
  ///
  /// In en, this message translates to:
  /// **'Reset filters'**
  String get mapSearchNoResultsResetFilters;
  ...
  /// No description provided for @mapSearchSheetTitle.
  ///
  /// In en, this message translates to:
  /// **'Search'**
  String get mapSearchSheetTitle;
  ...
  /// No description provided for @mapSearchSuggestionChipSemantic.
  ///
  /// In en, this message translates to:
  /// **'Search for {query}'**
  String mapSearchSuggestionChipSemantic(String query);

  /// No description provided for @mapSearchRecentChipSemantic.
  ///
  /// In en, this message translates to:
  /// **'Recent search {query}'**
  String mapSearchRecentChipSemantic(String query);

  /// No description provided for @mapSearchGeoIntentSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Show area on map'**
  String get mapSearchGeoIntentSubtitle;

  /// No description provided for @mapSearchGeoIntentSemantic.
  ///
  /// In en, this message translates to:
  /// **'Show {label} on map'**
  String mapSearchGeoIntentSemantic(String label);
  ...
  /// No description provided for @mapLocateFailedSnack.
  ///
  /// In en, this message translates to:
  /// **'Could not find your location. Check that location services are on.'**
  String get mapLocateFailedSnack;
  ...
  /// No description provided for @mapFilterButtonSemanticSitesMatch.
  ///
  /// In en, this message translates to:
  /// **'{count} sites match filters.'**
  String mapFilterButtonSemanticSitesMatch(int count);
  ...
  /// No description provided for @mapFilterArchivedSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Archived sites are hidden by default and are not controlled by status chips.'**
  String get mapFilterArchivedSubtitle;

  /// No description provided for @mapFilterShowSites.
  ///
  /// In en, this message translates to:
  /// **'Show {count} sites'**
  String mapFilterShowSites(int count);

  /// No description provided for @mapFilterSectionSelectAll.
  ///
  /// In en, this message translates to:
  /// **'All'**
  String get mapFilterSectionSelectAll;

  /// No description provided for @mapFilterSectionClear.
  ///
  /// In en, this message translates to:
  /// **'Clear'**
  String get mapFilterSectionClear;

  /// No description provided for @mapFilterMinSelectionAnnounce.
  ///
  /// In en, this message translates to:
  /// **'At least one option must stay selected.'**
  String get mapFilterMinSelectionAnnounce;

  /// No description provided for @mapFilterAreaSearchPlaceholder.
  ///
  /// In en, this message translates to:
  /// **'Search municipalities and areas'**
  String get mapFilterAreaSearchPlaceholder;
  ...
  /// No description provided for @reportPhotoReviewZoomResetHint.
  ///
  /// In en, this message translates to:
  /// **'Double-tap to reset zoom'**
  String get reportPhotoReviewZoomResetHint;

  /// No description provided for @reportPhotoReviewZoomInspectHint.
  ///
  /// In en, this message translates to:
  /// **'Pinch or double-tap to inspect'**
  String get reportPhotoReviewZoomInspectHint;
  ...
  /// No description provided for @notificationsSemanticReadState.
  ///
  /// In en, this message translates to:
  /// **'Read'**
  String get notificationsSemanticReadState;

  /// No description provided for @notificationsSemanticUnreadState.
  ///
  /// In en, this message translates to:
  /// **'Unread'**
  String get notificationsSemanticUnreadState;

  /// No description provided for @notificationsTileSemanticLabel.
  ///
  /// In en, this message translates to:
  /// **'{state} {type} notification: {title}'**
  String notificationsTileSemanticLabel(
    String state,
    String type,
    String title,
  );

  /// No description provided for @notificationsTileOpenRelatedHint.
  ///
  /// In en, this message translates to:
  /// **'Opens related content'**
  String get notificationsTileOpenRelatedHint;
  ...
  /// No description provided for @eventsOrganizerCheckInPauseResumeFailed.
  ///
  /// In en, this message translates to:
  /// **'Could not update check-in. Try again.'**
  String get eventsOrganizerCheckInPauseResumeFailed;
  ...
  /// No description provided for @eventsAttendeeReminderNotifyTitle.
  ///
  /// In en, this message translates to:
  /// **'Event reminder'**
  String get eventsAttendeeReminderNotifyTitle;

  /// No description provided for @eventsAttendeeReminderNotifyBody.
  ///
  /// In en, this message translates to:
  /// **'{title} is coming up. Tap to open.'**
  String eventsAttendeeReminderNotifyBody(String title);
  ...
  /// No description provided for @eventsDetailCalendarAlreadyAdded.
  ///
  /// In en, this message translates to:
  /// **'Already in your calendar.'**
  String get eventsDetailCalendarAlreadyAdded;

  /// No description provided for @eventsAddToCalendarAlreadyAdded.
  ///
  /// In en, this message translates to:
  /// **'Added to calendar'**
  String get eventsAddToCalendarAlreadyAdded;
  ...
  /// No description provided for @donateSheetSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Your contribution helps organize cleanups and keep sites healthy.'**
  String get donateSheetSubtitle;

  /// No description provided for @donateSheetOneTimeTitle.
  ///
  /// In en, this message translates to:
  /// **'One-time donation'**
  String get donateSheetOneTimeTitle;

  /// No description provided for @donateSheetOneTimeSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Give once to support this cause'**
  String get donateSheetOneTimeSubtitle;

  /// No description provided for @donateSheetMonthlyTitle.
  ///
  /// In en, this message translates to:
  /// **'Monthly contribution'**
  String get donateSheetMonthlyTitle;

  /// No description provided for @donateSheetMonthlySubtitle.
  ///
  /// In en, this message translates to:
  /// **'Recurring support for ongoing cleanups'**
  String get donateSheetMonthlySubtitle;
  ...
  /// No description provided for @siteHistorySummaryReports.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{1 report} other{{count} reports}}'**
  String siteHistorySummaryReports(int count);

  /// No description provided for @siteHistorySummaryCleanups.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{1 cleanup} other{{count} cleanups}}'**
  String siteHistorySummaryCleanups(int count);

  /// No description provided for @siteHistorySummaryActiveSince.
  ///
  /// In en, this message translates to:
  /// **'Active since {date}'**
  String siteHistorySummaryActiveSince(String date);

  /// No description provided for @siteHistoryStatReports.
  ///
  /// In en, this message translates to:
  /// **'Reports'**
  String get siteHistoryStatReports;

  /// No description provided for @siteHistoryStatCleanups.
  ///
  /// In en, this message translates to:
  /// **'Cleanups'**
  String get siteHistoryStatCleanups;

  /// No description provided for @siteHistoryStatEntries.
  ///
  /// In en, this message translates to:
  /// **'Entries'**
  String get siteHistoryStatEntries;
  ...
  /// No description provided for @siteHistoryLoadingSemantic.
  ///
  /// In en, this message translates to:
  /// **'Loading site history.'**
  String get siteHistoryLoadingSemantic;
  ...
  /// No description provided for @eventsAnalyticsLive.
  ///
  /// In en, this message translates to:
  /// **'Live'**
  String get eventsAnalyticsLive;

  /// No description provided for @eventsAnalyticsUpdatedAgo.
  ///
  /// In en, this message translates to:
  /// **'Updated {relative}'**
  String eventsAnalyticsUpdatedAgo(String relative);

  /// No description provided for @eventsAnalyticsStatJoined.
  ///
  /// In en, this message translates to:
  /// **'Joined {count}'**
  String eventsAnalyticsStatJoined(int count);

  /// No description provided for @eventsAnalyticsStatCheckedIn.
  ///
  /// In en, this message translates to:
  /// **'Checked in {count}'**
  String eventsAnalyticsStatCheckedIn(int count);

  /// No description provided for @eventsAnalyticsStatPending.
  ///
  /// In en, this message translates to:
  /// **'Pending {count}'**
  String eventsAnalyticsStatPending(int count);

  /// No description provided for @eventsAnalyticsStatTotalCheckIns.
  ///
  /// In en, this message translates to:
  /// **'Check-ins {count}'**
  String eventsAnalyticsStatTotalCheckIns(int count);

  /// No description provided for @eventsAnalyticsTotalCheckInsSummary.
  ///
  /// In en, this message translates to:
  /// **'{count} total check-ins recorded'**
  String eventsAnalyticsTotalCheckInsSummary(int count);

  /// No description provided for @eventsAnalyticsLastJoin.
  ///
  /// In en, this message translates to:
  /// **'Last join {relative}'**
  String eventsAnalyticsLastJoin(String relative);

  /// No description provided for @eventsAnalyticsLastCheckIn.
  ///
  /// In en, this message translates to:
  /// **'Last check-in {relative}'**
  String eventsAnalyticsLastCheckIn(String relative);

  /// No description provided for @eventsAnalyticsRelativeJustNow.
  ///
  /// In en, this message translates to:
  /// **'just now'**
  String get eventsAnalyticsRelativeJustNow;

  /// No description provided for @eventsAnalyticsRelativeMinutesAgo.
  ///
  /// In en, this message translates to:
  /// **'{minutes} min ago'**
  String eventsAnalyticsRelativeMinutesAgo(int minutes);

  /// No description provided for @eventsAnalyticsRelativeHoursAgo.
  ///
  /// In en, this message translates to:
  /// **'{hours} h ago'**
  String eventsAnalyticsRelativeHoursAgo(int hours);

  /// No description provided for @eventsAnalyticsRelativeDaysAgo.
  ///
  /// In en, this message translates to:
  /// **'{days} d ago'**
  String eventsAnalyticsRelativeDaysAgo(int days);

  /// No description provided for @eventsAnalyticsRelativeWeeksAgo.
  ///
  /// In en, this message translates to:
  /// **'{weeks} wk ago'**
  String eventsAnalyticsRelativeWeeksAgo(int weeks);
  ...
  /// No description provided for @pushPermissionOpenSettingsTitle.
  ///
  /// In en, this message translates to:
  /// **'Turn on notifications'**
  String get pushPermissionOpenSettingsTitle;

  /// No description provided for @pushPermissionOpenSettingsBody.
  ///
  /// In en, this message translates to:
  /// **'Notifications are off for Chisto.mk. Open Settings to allow alerts for cleanup reminders, events, and chat.'**
  String get pushPermissionOpenSettingsBody;

  /// No description provided for @pushPermissionOpenSettingsAction.
  ///
  /// In en, this message translates to:
  /// **'Open Settings'**
  String get pushPermissionOpenSettingsAction;

  /// No description provided for @locationPermissionDeniedSnack.
  ///
  /// In en, this message translates to:
  /// **'Location access is off. Open Settings to enable it.'**
  String get locationPermissionDeniedSnack;

  /// No description provided for @locationPermissionOpenSettingsTitle.
  ///
  /// In en, this message translates to:
  /// **'Turn on location'**
  String get locationPermissionOpenSettingsTitle;

  /// No description provided for @locationPermissionOpenSettingsBody.
  ///
  /// In en, this message translates to:
  /// **'Location is off for Chisto.mk. Open Settings to see nearby sites and center the map on you.'**
  String get locationPermissionOpenSettingsBody;

  /// No description provided for @locationPermissionOpenSettingsAction.
  ///
  /// In en, this message translates to:
  /// **'Open Settings'**
  String get locationPermissionOpenSettingsAction;
