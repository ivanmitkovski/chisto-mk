...
class AppLocalizationsMk extends AppLocalizations {
  ...
  @override
  String get authShowPasswordTooltip => 'Прикажи лозинка';

  @override
  String get authHidePasswordTooltip => 'Сокриј лозинка';
  ...
  @override
  String get profileGuestTitle => 'Најавете се за да го видите профилот';

  @override
  String get profileGuestSubtitle =>
      'Следете поени, управувајте со поставки и видете го вашиот придонес.';
  ...
  @override
  String get profileGeneralEmptyValue => 'Недостапно';
  ...
  String reportSubmitPhotosSkippedSnack(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count фотографии беа преголеми или недостасуваа и не беа прикачени.',
      one:
          '1 фотографија беше преголема или недостасуваше и не беше прикачена.',
    );
    return '$_temp0';
  }
  ...
  String reportSubmitPhotosCompressionWarningSnack(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count фотографии не можеа да се компремираат; се користеа оригиналите.',
      one: '1 фотографија не можеше да се компресира; се користеше оригиналот.',
    );
    return '$_temp0';
  }

  @override
  String get reportListOutboxQueuedChip => 'Пријавата е во ред за испраќање…';

  @override
  String get reportListOutboxUploadingChip => 'Се прикачуваат фотографии…';

  @override
  String get reportListOutboxSubmittingChip => 'Се испраќа пријавата…';
  ...
  @override
  String get reportListOutboxOfflineBanner => 'Пријавата чека интернет…';

  @override
  String get reportListOutboxCooldownBanner =>
      'Пријавата е паузирана. Обиди се по паузата.';

  @override
  String get reportDraftRestoreFailedSnack =>
      'Нацртот не можеше да се врати. Започнуваме одново.';
  ...
  @override
  String get feedNoLocationTitle => 'Потребен е пристап до локација';

  @override
  String get feedNoLocationHint =>
      'Вклучете локација во Поставувања за да видите места во близина.';

  @override
  String get feedNoLocationOpenSettings => 'Отвори Поставувања';
  ...
  @override
  String get mapSearchMinQueryTitle => 'Продолжете со пишување';

  @override
  String get mapSearchMinQuerySubtitle =>
      'Внесете најмалку 2 знаци за пребарување.';
  ...
  @override
  String get mapSearchSemanticSearching => 'Се пребаруваат сите места';
  ...
  @override
  String get mapSearchSemanticNoResults => 'Нема совпаѓања';

  @override
  String get mapSearchSemanticRemoteError =>
      'Не можеше да се пребараат сите места';

  @override
  String get mapSearchNoResultsResetFilters => 'Ресетирај филтри';
  ...
  @override
  String get mapSearchSheetTitle => 'Пребарај';
  ...
  String mapSearchSuggestionChipSemantic(String query) {
    return 'Пребарај $query';
  }

  @override
  String mapSearchRecentChipSemantic(String query) {
    return 'Неодамнешно пребарување $query';
  }

  @override
  String get mapSearchGeoIntentSubtitle => 'Прикажи област на мапата';

  @override
  String mapSearchGeoIntentSemantic(String label) {
    return 'Прикажи $label на мапата';
  }
  ...
  String get mapLocateFailedSnack =>
      'Не можеше да се најде вашата локација. Проверете дали услугите за локација се вклучени.';
  ...
  @override
  String get mapFilterButtonSemanticNoSites => 'Нема вчитани места.';
  ...
  String mapFilterButtonSemanticSitesMatch(int count) {
    return '$count места одговараат на филтрите.';
  }
  ...
  String get mapFilterArchivedSubtitle =>
      'Архивираните места се скриени стандардно и не се контролираат од статус чиповите.';

  @override
  String mapFilterShowSites(int count) {
    return 'Прикажи $count места';
  }

  @override
  String get mapFilterSectionSelectAll => 'Сите';

  @override
  String get mapFilterSectionClear => 'Исчисти';

  @override
  String get mapFilterMinSelectionAnnounce =>
      'Барем една опција мора да остане избрана.';

  @override
  String get mapFilterAreaSearchPlaceholder => 'Пребарај општини и подрачја';
  ...
  String get reportPhotoReviewZoomResetHint =>
      'Двоен допир за ресетирање на зумот';

  @override
  String get reportPhotoReviewZoomInspectHint =>
      'Стисни или двоен допир за преглед';
  ...
  @override
  String get notificationsSemanticReadState => 'Прочитано';

  @override
  String get notificationsSemanticUnreadState => 'Непрочитано';
  ...
  String notificationsTileSemanticLabel(
    ...
    return '$state известување од тип $type: $title';
  }

  @override
  String get notificationsTileOpenRelatedHint => 'Отвора поврзана содржина';
  ...
  String get eventsOrganizerCheckInPauseResumeFailed =>
      'Не можевме да ја ажурираме пријавата. Обидете се повторно.';
  ...
  @override
  String get eventsAttendeeReminderNotifyTitle => 'Потсетник за настан';

  @override
  String eventsAttendeeReminderNotifyBody(String title) {
    return '$title наскоро започнува. Допрете за отворање.';
  }
  ...
  @override
  String get eventsCtaUploadAfterPhotos => 'Прикачи фотографии подоцна';
  ...
  @override
  String get eventsDetailCalendarAlreadyAdded => 'Веќе е во вашиот календар.';

  @override
  String get eventsAddToCalendarAlreadyAdded => 'Додадено во календар';
  ...
  @override
  String get eventsFeedbackBagsCollected => 'Собрани ќеси';
  ...
  @override
  String get donateSheetTitle => 'Поддржи ги акциите за чистење';

  @override
  String get donateSheetSubtitle =>
      'Вашата донација помага да се организираат чистења и местата да останат здрави.';

  @override
  String get donateSheetOneTimeTitle => 'Еднократна донација';

  @override
  String get donateSheetOneTimeSubtitle => 'Донирај еднаш за оваа кауза';

  @override
  String get donateSheetMonthlyTitle => 'Месечна поддршка';

  @override
  String get donateSheetMonthlySubtitle =>
      'Редовна поддршка за тековни чистења';
  ...
  String siteHistoryKindStatusChanged(String from, String to) {
    return 'Статус променет од $from во $to';
  }
  ...
  String siteHistorySummaryActiveSince(String date) {
    return 'Активно од $date';
  }

  @override
  String get siteHistoryStatReports => 'Пријави';

  @override
  String get siteHistoryStatCleanups => 'Чистења';

  @override
  String get siteHistoryStatEntries => 'Записи';
  ...
  String get siteHistoryLoadingSemantic =>
      'Се вчитува историјата на локацијата.';
  ...
  @override
  String get commonNotAvailable => 'Недостапно';
  ...
  String eventsFieldModeRowLiveImpactBags(int count) {
    return 'Влијание во живо · $count ќеси';
  }
  ...
  @override
  String get eventsCompletedBagsSectionTitle => 'Собрани ќеси со отпад';

  @override
  String get eventsCompletedBagsSave => 'Зачувај';

  @override
  String get eventsCompletedBagsDecrease => 'Намали број на ќеси';

  @override
  String get eventsCompletedBagsIncrease => 'Зголеми број на ќеси';

  @override
  String get eventsCompletedBagsSaved => 'Бројот на ќеси е зачуван.';
  ...
  String get organizerToolkitPage8Body =>
      'Фотографиите подоцна и бројот на ќеси треба да ја одразуваат вистината. Точно известување гради доверба кај доброволците, модераторите и пошироката заедница.';
  ...
  @override
  String get pushPermissionOpenSettingsTitle => 'Вклучи известувања';

  @override
  String get pushPermissionOpenSettingsBody =>
      'Известувањата се исклучени за Chisto.mk. Отвори Поставувања за да дозволиш потсетници, настани и чет.';

  @override
  String get pushPermissionOpenSettingsAction => 'Отвори Поставувања';

  @override
  String get locationPermissionDeniedSnack =>
      'Пристапот до локација е исклучен. Отворете Поставувања за да го вклучите.';

  @override
  String get locationPermissionOpenSettingsTitle => 'Вклучи локација';

  @override
  String get locationPermissionOpenSettingsBody =>
      'Локацијата е исклучена за Chisto.mk. Отворете Поставувања за да видите места во близина и да ја центрирате мапата.';

  @override
  String get locationPermissionOpenSettingsAction => 'Отвори Поставувања';
  ...
  @override
  String get locationPickerAddressPlaceholder => 'Нема адреса';
