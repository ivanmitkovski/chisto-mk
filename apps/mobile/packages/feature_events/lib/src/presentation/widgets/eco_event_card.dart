...
import 'package:feature_events/src/presentation/utils/ellipsize_words_to_max_width.dart';
              ...
              Positioned(
                ...
                child: ColoredBox(
                  ...
                  child: const SizedBox(
                    width: AppSpacing.eventsLiveAccentWidth,
                  ),
                ),
              ),
            Padding(
                        ...
                        children: <Widget>[
                          ...
                          if (event.status == EcoEventStatus.inProgress)
                            Row(
                              ...
                              children: <Widget>[
                                _StatusChip(status: event.status, isLive: true),
                                ...
                                child: LayoutBuilder(
                                  builder:
                                      (
                                        ...
                                        final TextStyle distStyle = metaStyle
                                            .copyWith(
                                              color:
                                                  colorScheme.onSurfaceVariant,
                                            );
                                        ...
                                        final String? suffix =
                                            ...
                                            ? ' · ${_ecoEventCardDistanceLabel(context, displayDistanceKm)}'
                                            : null;
                                        final double siteMaxWidth;
                                        if (suffix == null) {
                                          siteMaxWidth = constraints.maxWidth;
                                        } else {
                                          final TextPainter suffixPainter =
                                              TextPainter(
                                                text: TextSpan(
                                                  text: suffix,
                                                  style: distStyle,
                                          ...
                                          siteMaxWidth = math.max(
                                            0,
                                            constraints.maxWidth -
                                                suffixPainter.width,
                                          );
                                        }
                                        final String siteShown =
...
class _Thumbnail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ColorScheme colorScheme = Theme.of(context).colorScheme;
    const double thumb = AppSpacing.eventsCardThumbnailSize;
