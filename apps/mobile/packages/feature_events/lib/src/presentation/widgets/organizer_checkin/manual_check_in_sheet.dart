...
class _ManualCheckInSheetState extends State<ManualCheckInSheet> {
  ...
  Set<String> get _checkedInUserIds {
    final List<CheckedInAttendee> list = readCheckInRepository()
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        final double maxAllowed = math.min(parentMax, maxBelowNotch);
        final double desired = screenH * _sheetHeightFraction;
        final double sheetHeight = math.min(maxAllowed, math.max(280, desired));
            ...
            child: Material(
              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  ...
                  boxShadow: AppShadows.sheetFooterLift(),
                ),
                child: ClipRRect(
                  borderRadius: const BorderRadius.vertical(
                    top: Radius.circular(AppSpacing.radiusCard),
