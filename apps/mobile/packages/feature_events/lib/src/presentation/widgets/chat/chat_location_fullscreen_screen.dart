...
import 'package:feature_events/src/presentation/widgets/chat/chat_location_maps.dart';
  ...
  return Navigator.of(context).push<void>(
    MaterialPageRoute<void>(
      builder: (BuildContext ctx) =>
          ChatLocationFullscreenScreen(lat: lat, lng: lng, label: label),
    ),
  );
}
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () async {
                        ...
                        if (context.mounted) {
                          AppSnack.show(
                            context,
                            message: context.l10n.eventChatCopied,
                          );
                        }
                      },
