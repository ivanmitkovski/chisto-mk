...
import 'package:feature_events/src/presentation/widgets/chat/voice_recording_constants.dart';
...
class _VoiceRecordingMeterState extends State<VoiceRecordingMeter>
  ...
  static const Duration _amplitudeInterval =
      VoiceRecordingConstants.amplitudeSampleInterval;
  static const double _scrollPeriodSec =
      VoiceRecordingConstants.scrollPeriodSeconds;
  ...
  static double _normalizeDbfs(double db) {
    ...
    final double x = ((db.clamp(_dbMin, _dbMax) - _dbMin) / (_dbMax - _dbMin))
        .clamp(0.0, 1.0);
