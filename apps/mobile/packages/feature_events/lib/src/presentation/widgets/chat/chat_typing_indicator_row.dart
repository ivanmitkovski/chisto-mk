...
class _TypingAvatar extends StatelessWidget {
  const _TypingAvatar({required this.displayName, this.userId, this.imageUrl});
...
class _ChatTypingDotsState extends State<ChatTypingDots>
  ...
  void initState() {
    ...
    _controller = AnimationController(
      vsync: this,
      duration: AppMotion.chatTypingCycle,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        final double t = AppMotion.chatTypingPhaseCurve.transform(
          _controller.value,
        );
        return Row(
          mainAxisSize: MainAxisSize.min,
