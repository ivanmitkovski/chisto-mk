...
import 'package:feature_events/src/domain/macedonia_geo_fence.dart';
...
class _CreateEventSitesMapState extends State<CreateEventSitesMap> {
  ...
  static final LatLngBounds _macedoniaBounds = LatLngBounds(
    const LatLng(MacedoniaGeoFence.minLat, MacedoniaGeoFence.minLng),
    const LatLng(MacedoniaGeoFence.maxLat, MacedoniaGeoFence.maxLng),
  );
        ...
        child: FlutterMap(
          ...
          options: MapOptions(
            initialCenter: const LatLng(
              MacedoniaGeoFence.centerLat,
              MacedoniaGeoFence.centerLng,
            ),
            initialZoom: 11,
            maxZoom: 18,
