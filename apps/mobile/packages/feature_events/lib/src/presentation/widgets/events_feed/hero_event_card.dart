...
class HeroEventCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool showLeadingCountdown = !event.startDateTime.isBefore(now);
    final String countdownLabel = eventsCountdownLabel(
      context.l10n,
      event.startDateTime,
    );
                    ...
                    Positioned(
                      ...
                      child: DecoratedBox(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            countdownLabel,
                            style: AppTypography.eventsHeroCountdownLabel(
                              textTheme,
                            ),
                          ),
                        ),
                  ...
                  Positioned(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          height: metaTwoLines ? AppSpacing.xs : AppSpacing.xxs,
                        ),
                        if (metaTwoLines)
                          _HeroMetaColumn(
                            ...
                            textTheme: textTheme,
                            showTooltip:
                                event.siteName.length >
                                _kLocationTooltipCharThreshold,
                          )
                        else
                          _HeroMetaRow(
                            siteName: event.siteName,
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: showTooltip
              ? Tooltip(message: siteName, child: location)
              : location,
        ),
        const SizedBox(width: AppSpacing.radiusSm),
        Text(timeRange, style: AppTypography.eventsHeroCardMeta(textTheme)),
      ],
    );
  }
}
    ...
    return Column(
      ...
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            const Padding(
              padding: EdgeInsets.only(top: AppSpacing.radiusHandle),
              child: Icon(
                CupertinoIcons.location_solid,
                size: AppSpacing.iconSm * 0.75,
                color: AppColors.textOnDarkMuted,
