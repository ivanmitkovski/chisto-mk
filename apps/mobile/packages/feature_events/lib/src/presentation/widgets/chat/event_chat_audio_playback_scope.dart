...
class EventChatAudioPlaybackController extends ChangeNotifier {
  EventChatAudioPlaybackController() {
    _playingSub = _player.playingStream.listen(
      (_) => _emitIfAlive(notifyListeners),
    );
...
class EventChatAudioPlaybackScope
    extends InheritedNotifier<EventChatAudioPlaybackController> {
  ...
  static EventChatAudioPlaybackController of(BuildContext context) {
    final EventChatAudioPlaybackScope? scope = context
