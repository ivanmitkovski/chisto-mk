...
import 'package:feature_events/src/presentation/view_models/weather_card_view_model.dart';
...
import 'package:feature_events/src/presentation/widgets/event_detail/weather_indicative_info_sheet.dart';
...
class WeatherCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final WeatherCardState vm = ref.watch(weatherCardViewModelProvider(event));
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: vm.loading
              ...
              : _buildContent(context, vm.dayWeather!),
        ),
        ...
        Align(
          ...
          child: AppButton.text(
            ...
            onPressed: () {
              unawaited(
                ref
                    .read(weatherCardViewModelProvider(event).notifier)
                    .load(event),
              );
            },
          ),
  ...
  Widget _buildContent(BuildContext context, DayWeather w) {
    ...
    final String tempRange = '${w.minTempC.round()}° – ${w.maxTempC.round()}°C';
  ...
  static Color _colorFor(WeatherWmoVisual v) {
    return switch (v) {
      WeatherWmoVisual.clear ||
      WeatherWmoVisual.mainlyClear => AppColors.accentWarning,
      WeatherWmoVisual.partlyCloudy ||
      WeatherWmoVisual.overcast ||
      WeatherWmoVisual.fog => AppColors.textMuted,
      WeatherWmoVisual.snow ||
      WeatherWmoVisual.snowShowers => AppColors.accentInfo,
      WeatherWmoVisual.thunderstorm => AppColors.accentWarningDark,
      WeatherWmoVisual.drizzle ||
      WeatherWmoVisual.rain ||
      WeatherWmoVisual.rainShowers => AppColors.accentInfo,
    };
  }
}
