  ...
  return AppBottomSheet.show<void>(
    ...
    builder: (BuildContext ctx) {
      ...
      return AppSheetScaffold(
        title: context.l10n.eventChatPinnedMessagesTitle,
        useModalRouteShape: true,
        titleTextStyle: AppTypography.eventsCalendarMonthTitle(
            ...
            Row(
              children: <Widget>[
                ...
                Text(
                  ...
                  ).copyWith(color: ChatTheme.avatarColor(message.authorId)),
                ),
                if (message.pinnedByDisplayName != null &&
                    message.pinnedByDisplayName!.isNotEmpty) ...<Widget>[
                  const Spacer(),
                  Text(
                    context.l10n.eventChatPinnedBy(
                      message.pinnedByDisplayName!,
                    ),
