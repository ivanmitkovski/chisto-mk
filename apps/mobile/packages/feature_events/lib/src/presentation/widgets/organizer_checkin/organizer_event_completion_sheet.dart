...
class _OrganizerEventCompletionSheetBodyState
  ...
  void initState() {
    ...
    _scale = CurvedAnimation(parent: _markController, curve: AppMotion.spring);
  ...
  void didChangeDependencies() {
    ...
    _markController.duration = reduceMotion
        ? Duration.zero
        : AppMotion.emphasizedDuration;
    if (reduceMotion) {
          ...
          children: <Widget>[
            PrimaryButton(
              ...
              onPressed: () {
                Navigator.of(
                  context,
                ).pop(OrganizerEventCompletionAction.dismissed);
              },
            ),
            ...
            AppButton.outlined(
              ...
              onPressed: () {
                Navigator.of(
                  context,
                ).pop(OrganizerEventCompletionAction.openImpactReceipt);
              },
              expand: true,
            ),
            const SizedBox(height: AppSpacing.sm),
            AppButton.outlined(
              ...
              onPressed: () {
                Navigator.of(
                  context,
                ).pop(OrganizerEventCompletionAction.openEvidence);
              },
              expand: true,
            ),
          ],
