            ...
            children: <Widget>[
              ...
              if (isOrganizer)
                Semantics(
                  ...
                  child: IconButton(
                    tooltip: context.l10n.eventsOrganizerDashboardTitle,
                    onPressed: () {
                      EventsNavigation.openOrganizerDashboard(context);
                    },
            ...
            children: <Widget>[
              Expanded(
                child: AppCupertinoSearchField(
                  ...
                  toolbarHeight: AppSpacing.eventsFeedToolbarControlSize,
                  placeholder: context.l10n.eventsFeedSearchPlaceholder,
                  semanticLabel: context.l10n.eventsFeedSearchPlaceholder,
                  onChanged: _onSearchChanged,
                  onSubmitted: () {
                    unawaited(
                      _feed.rememberSearch(_feed.searchController.text),
                    );
                  },
                  onClear: () {
                    unawaited(() async {
