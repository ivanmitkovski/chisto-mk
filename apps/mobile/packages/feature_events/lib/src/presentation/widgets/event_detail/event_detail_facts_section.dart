...
import 'package:feature_events/src/presentation/utils/event_location_detail_sheet.dart';
...
import 'package:feature_events/src/presentation/widgets/event_detail/event_details_grid.dart';
import 'package:feature_events/src/presentation/widgets/event_detail/location_chip.dart';
...
class EventDetailFactsSection extends StatelessWidget {
  const EventDetailFactsSection({super.key, required this.event});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        DateTimeSection(event: event, embeddedInGroupedPanel: false),
                ...
                children: <Widget>[
                  ...
                  if (hasCoords)
                    IconButton(
                      ...
                      onPressed: () =>
                          LocationChip.openMapsSheet(context, event),
                      icon: const Icon(
        ...
        child: Wrap(
          ...
          children: <Widget>[
            DetailChip(
              ...
              color: AppColors.primaryDark,
              onTap: () =>
                  CategorySection.showCategoryInfoSheet(context, event),
            ),
            if (event.scale != null)
              DetailChip(
                ...
                color: AppColors.primaryDark,
                onTap: () =>
                    EventDetailsGrid.openScaleInfoSheet(context, event),
              ),
