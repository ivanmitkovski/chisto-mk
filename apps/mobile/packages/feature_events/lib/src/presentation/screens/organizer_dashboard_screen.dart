...
import 'package:feature_events/src/presentation/widgets/offline_work_hub_sheet.dart';
...
class _OrganizerDashboardScreenState
  ...
  EventsRepository get _eventsStore => readEventsRepository();
                              ...
                              (
                                ...
                                return IconButton(
                                  ...
                                  icon: Badge(
                                    label: Text(
                                      badge,
                                      style: AppTypography.microIndex(
                                        textTheme,
