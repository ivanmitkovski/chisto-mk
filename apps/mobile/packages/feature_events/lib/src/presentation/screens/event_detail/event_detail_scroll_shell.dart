...
extension EventDetailScrollShell on _EventDetailScreenState {
  Widget buildEventDetailScrollShell(BuildContext context) {
    ...
    if (!_detailPrefetchDone && event == null) {
      return Scaffold(
        ...
        body: const AnimatedPhaseSwitcher(
          phaseKey: 'skeleton',
  ...
  void _openFullscreenGallery(BuildContext context, EcoEvent event, int index) {
    Navigator.of(context).push<void>(
      MaterialPageRoute<void>(
        builder: (BuildContext ctx) =>
            FullscreenGalleryPage(event: event, initialIndex: index),
      ),
    );
  }
}
