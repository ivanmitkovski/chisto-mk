...
class FieldModeScreen extends ConsumerStatefulWidget {
  const FieldModeScreen({super.key});

  @override
  ConsumerState<FieldModeScreen> createState() => _FieldModeScreenState();
}

class _FieldModeScreenState extends ConsumerState<FieldModeScreen>
  ...
  Future<void> _syncNow() async {
    ...
    try {
      final FieldModeSyncService sync = ref.read(fieldModeSyncServiceProvider);
