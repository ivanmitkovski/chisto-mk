...
OrganizerQuizPayload? parseOrganizerQuizPayload(
  ...
  final String? session = _nonEmptyString(root, const <String>[
    'quizSession',
    'quiz_session',
  ]);
  ...
  return OrganizerQuizPayload(session: session, rawQuestions: rawQuestions);
}
