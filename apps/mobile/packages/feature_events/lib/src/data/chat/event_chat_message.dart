...
Map<String, dynamic>? _jsonMap(Object? value) {
  ...
  if (value is Map) {
    return value.map((Object? k, Object? val) => MapEntry(k.toString(), val));
  }
  return null;
}

/// Server-backed event chat message (REST + SSE).
enum EventChatMessageType { text, system, image, location, video, audio, file }
...
class EventChatMessage {
  ...
  static EventChatMessage? tryFromJson(Map<String, dynamic>? json) {
    ...
    final String authorId = author?['id'] is String
        ? author!['id']! as String
        : '';
    final String authorName = author?['displayName'] is String
    ...
    final String? replyToSnippet = replyTo?['snippet'] is String
        ? replyTo!['snippet']! as String
        : null;
