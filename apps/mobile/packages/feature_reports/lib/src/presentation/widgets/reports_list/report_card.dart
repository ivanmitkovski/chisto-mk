...
import 'package:feature_reports/src/presentation/widgets/reports_list/report_card_thumbnail.dart';
...
class _ReportCardState extends State<ReportCard>
  ...
  void didUpdateWidget(ReportCard oldWidget) {
    ...
    if (_rowWantsKeepAlive(oldWidget.report) !=
        _rowWantsKeepAlive(widget.report)) {
      updateKeepAlive();
    }
  }
                                        ...
                                        child: Wrap(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(
                                              ...
                                              style:
                                                  AppTypographySurfaces.reportsBadgeLabel(
                                                    textTheme,
                                                  ),
                                            ),
                                          ],
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                  '+${report.score}',
                                                  style:
                                                      AppTypographySurfaces.reportsRowValueStrong(
                                                        textTheme,
                                                      ),
                                                ),
                                              ],
