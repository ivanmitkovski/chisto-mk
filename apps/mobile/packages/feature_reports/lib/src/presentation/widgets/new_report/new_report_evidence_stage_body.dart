...
import 'package:feature_reports/src/presentation/widgets/new_report/evidence_tip_card.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        if (draft.photos.isEmpty && !evidenceTipDismissed)
          EvidenceTipCard(onDismiss: onDismissTip),
        if (draft.photos.isEmpty && !evidenceTipDismissed)
        ...
        if (attemptedStages.contains(ReportStage.evidence) &&
          ...
          Text(
            ...
            style: AppTypographySurfaces.reportsEvidenceValidationHint(
