...
abstract class ReportOutboxRepository {
  ...
  /// Removes every outbox row (logout / account switch). Default no-op for fakes.
...
class SqfliteReportOutboxRepository implements ReportOutboxRepository {
  ...
  List<String> _attemptedStagesFromDb(String? raw) {
    ...
    try {
      ...
      AppLog.warn(
        'report outbox: failed to decode attempted stages JSON',
        error: error,
  ...
  Map<String, Object?> _toRow(ReportOutboxEntry e) {
    ...
    return <String, Object?>{
      ...
      'media_urls_json': e.mediaUrls == null || e.mediaUrls!.isEmpty
          ? null
