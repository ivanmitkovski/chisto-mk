/// Stable placeholder idempotency key for wizard autosave rows (not used for POST).
String wizardDraftPlaceholderIdempotencyKey() =>
    'idem_$kReportWizardDraftRowId';

bool isWizardDraftPlaceholderIdempotencyKey(String key) =>
    key == wizardDraftPlaceholderIdempotencyKey();
