...
class ReportDraftJsonCodec {
  ...
  static ({ReportDraft draft, String title, String description}) decode(
    String json,
  ) {
    final Object? decoded = jsonDecode(json);
    if (decoded is! Map<String, dynamic>) {
      return (draft: ReportDraft(), title: '', description: '');
    }
    final Map<String, dynamic> m = decoded;
    final List<dynamic>? paths = safeAsList(m['photos']);
    ...
    return (
      draft: ReportDraft(
        ...
        cleanupEffort: CleanupEffort.fromApiString(
          m['cleanupEffort'] as String?,
        ),
