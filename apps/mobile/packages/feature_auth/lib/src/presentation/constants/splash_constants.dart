...
class SplashConstants {
  ...
  static const double logoMinWidth = 120;
  static const double logoMaxWidth = 260;
  ...
  static const double logoHeight = 231;
  ...
  static const Duration splashToInitialTransitionDuration = Duration(
    milliseconds: 280,
  );
  ...
  static const Duration initialRouteMinDisplayTime = Duration(
    milliseconds: 320,
  );
}
