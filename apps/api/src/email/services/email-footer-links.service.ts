...
import { resolveEmailLogo, type ResolvedEmailLogo } from '../util/email-logo';
import { resolveAppBaseUrl } from '../util/email-urls';
...
export class EmailFooterLinksService {
  ...
  brandingUrls(): { appBaseUrl: string } & ResolvedEmailLogo {
    return {
