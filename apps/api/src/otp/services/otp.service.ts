...
export class OtpService {
  ...
  /**
   * Validates the OTP and deletes the record on success inside a transaction.
   */
  async verifyAndConsume(
    ...
    const record = (await tx.phoneOtp.findUnique({
    ...
    await tx.phoneOtp.delete({ where: { phoneNumber: normalized } });
  }
