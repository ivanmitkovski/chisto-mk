...
import { verifyCheckInQrToken } from '../types/check-in-qr-token';
...
} from '../types/check-in-redemption-validator';
...
import type { RedeemResult } from '../types/events-check-in.types';
