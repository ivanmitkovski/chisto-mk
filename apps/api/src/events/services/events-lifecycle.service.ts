...
import { canTransitionLifecycle } from '../util/events-lifecycle.util';
...
import { SiteLifecycleFromEventsService } from '../../sites/services/site-lifecycle-from-events.service';
