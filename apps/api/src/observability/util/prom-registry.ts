...
export const httpClientErrorsTotal = new Counter({
  name: 'chisto_http_client_errors_total',
...
export const authLoginFailedTotal = new Counter({
  name: 'chisto_auth_login_failed_total',
  help: 'Citizen login failures (invalid credentials)',
  labelNames: ['reason'] as const,
  registers: [promRegistry],
});

export const authLoginLockedTotal = new Counter({
  name: 'chisto_auth_login_locked_total',
  help: 'Citizen login attempts blocked by lockout',
  registers: [promRegistry],
});

export const emailSendTotal = new Counter({
  name: 'chisto_email_send_total',
  help: 'Email send attempts by result',
  labelNames: ['result', 'template'] as const,
  registers: [promRegistry],
});

export const emailOutboxDepth = new Gauge({
  name: 'chisto_email_outbox_depth',
  help: 'Email delivery outbox rows pending or retrying',
  registers: [promRegistry],
});

export const metricsPushFailedTotal = new Counter({
  name: 'chisto_metrics_push_failed_total',
  help: 'Prometheus pushgateway push failures',
  registers: [promRegistry],
});
