...
let feedFeedbackCounts: Record<string, number> = {};
let feedCacheInvalidationCounts: Record<string, number> = {};
let feedCacheEntries = 0;
let feedReasonCodeCounts: Record<string, number> = {};
let feedPaginationContinuityIssues = 0;
let feedV2Requests = 0;
let feedV2Fallbacks = 0;
let feedV2StageLatenciesMs: Record<string, number[]> = {};
